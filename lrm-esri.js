(function e(t, n, r) {
...
})(
  {
    ...
    7: [
      ...
      { "global/window": 2, "is-function": 4, "parse-headers": 5, xtend: 8 },
    ],
    8: [
      function (require, module, exports) {
          ...
          (function () {
            ...
            module.exports = L.Class.extend({
                    ...
                    if (!timedOut) {
                      if (!err) {
                        try {
                          ...
                          error.status = -2;
                          error.message =
                            "Error parsing response: " + ex.toString();
                        }
                      } else {
                        error.message =
                          "HTTP request failed: " +
              ...
              _routeDone: function (
                ...
                actualWaypoints = this._esriToWaypoints(
                  inputWaypoints,
                  response.stops.features
                );
              ...
              _convertRoute: function (responseRoute, summary) {
                ...
                for (i = 0; i < legCount; i++) {
                  ...
                  for (j = 0; j < leg.length; j++) {
                    step = leg[j];
                    geometry = this._esriDecodePolyline(
                      step.compressedGeometry
                    );
                    result.coordinates.push.apply(result.coordinates, geometry);
                    type = this._esriManeuverToInstructionType(
                      step.attributes,
                      i === legCount - 1
                    );
                    ...
                    if (step.attributes.maneuverType) {
                      if (
                        (i == 0 &&
                          step.attributes.maneuverType == "esriDMTDepart") ||
                        step.attributes.maneuverType == "esriDMTStop"
                      ) {
